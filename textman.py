"""
BUG:
- Trying to load a ROM after already having it loaded causes the editor to crash.
  - Noted here because this code file seems to be the culprit.

TODO: 
- Documentation/commenting; I haven't touched this file since taking on some of the development 
  work of this editor, except to move the TextTableModel here.
- Code cleanup in general, where appropriate.
"""
...
# Defines how text data is edited and displayed
